...
class Utilities {
	...
	public static function render_hello() {
	 ...
	 */
	public static function svg_kses_allowed_html() {
	 ...
	 * @return void
	 */
	public static function register_icons( $options ) {
	 ...
	 */
	public static function render_icon( $icon_set, $icon_name ) {
	 ...
	 */
	public static function get_icon( $icon_set, $icon_name ) {
	 ...
	 * @return array
	 */
	public static function get_serialized_icons( $icon_set ) {
